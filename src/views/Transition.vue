<template>
  ...
  <div class="demo">
    <VDragDrop class="drag" tag="span" :droppable="false" v-for="i in items" :key="i" :dataTransfer="{value: i}">
      {{i}}
    ...
    <div>
         ...
         <VDragDrop @drag="drag" @dragend="dragend" v-for="doc in docs" :key="doc" :dataTransfer="{value: doc}">
